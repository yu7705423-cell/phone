...
await page.fill('input[placeholder="例如 SiliconFlow"]', '我的中转站');
await page.fill('input[placeholder="https://api.siliconflow.cn"]', 'https://api.siliconflow.cn');
await page.fill('input[placeholder="sk-..."]', 'sk-mine');
