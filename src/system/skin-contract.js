...
export const HOOKS = [
  ...
  { hook: 'inner', label: '心声：贴在气泡下面的那一行', on: ['chat'], since: 2,
    needs: '会话「互动」里开启心声，「显示成什么样」选「淡色小字」，并点过角色头像' },
  { hook: 'inner-card', label: '心声：点头像弹出的那张卡', on: ['chat'], since: 2,
    needs: '会话「互动」里开启心声，「显示成什么样」选「打开一页」，并点过角色头像',
    note: '列出历史时另带内部类名 is-listing' },
  { hook: 'inner-card-text', label: '心声那张卡上的正文', on: ['chat'], since: 2,
    needs: '同上' },
